...
const AttendanceData = () => {
  ...
  useEffect(() => {
    const fetchAttendanceData = async () => {
      try {
        const response = await fetch("https://dimension-attendance-leave-system.vercel.app/api/getAttendance-Data", {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch("https://dimension-attendance-leave-system.vercel.app/api/updateAttendance", {
